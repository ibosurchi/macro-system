...
def page_catalyst_forecaster(fred_key: str, channel_name: str, auth_user: dict | None = None) -> None:
    ...
    with st.spinner("Synthesizing upcoming economic calendar, precursor FRED pipelines & correlated news..."):
        ...
        # Forex Factory is already the authoritative calendar source. Once its `actual`
        # field becomes available, fill only missing cache entries automatically.
        # Existing Admin Actual Override values always take precedence.
...
def render_public_home() -> None:
    ...
    <style>
      ...
      .apex-ref-copy{
        ...
        max-width:630px;
        color:#d3dce3;
        background-image:url("data:image/webp;base64, উঁচুবর্গ观点：
ApexMacro landing page, including CSS and HTML structure.

指令：
Fix icon CSS to enforce controlled sizing with !important and add overflow:hidden to icon container. Also add explicit max-width constraint to the features shell on desktop.
...
...
      ...
      .apex-feature-icon{width:80px !important;height:80px !important;flex:0 0 80px !important;display:flex !important;align-items:center !important;justify-content:center !important;margin:0 0 24px;border-radius:22px;background:rgba(32,221,234,.035);border:1px solid rgba(32,221,234,.20);color:#20ddea;overflow:hidden !important;}
      .apex-feature-icon svg,.apex-feature-icon img{display:block !important;width:44px !important;height:44px !important;max-width:44px !important;max-height:44px !important;min-width:0 !important;min-height:0 !important;flex-shrink:0;}
      ...
      .apex-feature-secondary .apex-feature-icon{width:42px !important;height:42px !important;flex:0 0 42px !important;margin:0;border-radius:12px;}
      .apex-feature-secondary .apex-feature-icon svg{width:26px !important;height:26px !important;max-width:26px !important;max-height:26px !important;}
      ...
      @media(min-width:769px) and (max-width:1100px){
        ...
        .apex-feature-icon{width:68px !important;height:68px !important;flex:0 0 68px !important;flex-basis:68px;margin-bottom:20px;}
        .apex-feature-icon svg,.apex-feature-icon img{width:40px !important;height:40px !important;max-width:40px !important;max-height:40px !important;}
      ...
      @media(max-width:700px){
        ...
        .apex-feature-icon{grid-area:icon;width:48px !important;height:48px !important;flex:0 0 48px !important;margin:0;border-radius:14px;overflow:hidden !important;}
        .apex-feature-icon svg,.apex-feature-icon img{width:44px !important;height:44px !important;max-width:44px !important;max-height:44px !important;}
      ...
      <section id="apex-features" class="apex-features-shell">
        ...
        <div class="apex-feature-grid">
          <article class="apex-feature-card cyan">
            <div class="apex-feature-icon"><svg width="44" height="44" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M4 18l5-6 4 3 7-9"/><path d="M16 6h4v4"/></svg></div>
          ...
          <article class="apex-feature-card purple">
            <div class="apex-feature-icon"><svg width="44" height="44" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><circle cx="12" cy="12" r="5"/><path d="M12 2v3M12 19v3M2 12h3M19 12h3"/></svg></div>
          ...
          <article class="apex-feature-card gold">
            <div class="apex-feature-icon"><svg width="44" height="44" viewBox="0 0 24 24" fill="currentColor"><path d="M13.5 1L5 13h6l-1 10 9-13h-6z"/></svg></div>
        ...
        <div class="apex-feature-secondary-grid" aria-label="Additional ApexMacro intelligence features">
          <article class="apex-feature-secondary">
            <div class="apex-feature-icon" style="color:#1a9fff;border-color:rgba(26,159,255,.20);background:rgba(26,159,255,.035);"><svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><rect x="4" y="5" width="16" height="15" rx="2"/><path d="M8 3v4M16 3v4M4 10h16"/></svg></div>
          ...
          <article class="apex-feature-secondary">
            <div class="apex-feature-icon"><svg width="26" height="26" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8"><path d="M21 3L3 10l7 3 3 7 8-17z"/><path d="M10 13l5-5"/></svg></div>
