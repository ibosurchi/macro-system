"""
FX Macro & Geopolitical Intelligence Desk — v10.2 Full Groq Integration
Institutional-Grade Multi-Timeframe Macro Analysis & Predictive Calendar
Live Integration: Groq Llama 3.1 + Telegram (@Forex_LiveStream) + Multi-Feed RSS + FRED (DFII10)
"""
...
def main() -> None:
    ...
    with st.sidebar:
        ...
        <div style="padding:5px 7px 14px;border-bottom:1px solid rgba(255,255,255,0.06);margin-bottom:12px;">
          ...
          <div style="font-size:9.5px;color:#6b7280;">INTELLIGENCE DESK v10.2 (Groq)</div>
        </div>
        """)
