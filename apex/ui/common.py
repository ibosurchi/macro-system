...
.st-key-apex_mobile_header [data-testid="column"]:last-child{flex:0 0 54px!important;min-width:54px!important;max-width:54px!important;display:flex!important;justify-content:flex-start!important;padding:0!important;overflow:visible!important;}
.st-key-apex_mobile_header [data-testid="column"]:last-child [data-testid="stButton"]{width:40px!important;min-width:40px!important;max-width:40px!important;margin-left:0!important;margin-right:14px!important;}
.st-key-apex_mobile_header button{width:40px!important;height:40px!important;min-height:40px!important;max-width:40px!important;padding:0!important;border-radius:10px!important;border:1px solid rgba(39,220,231,.45)!important;background:rgba(6,22,31,.90)!important;color:#27dce7!important;font-size:19px!important;box-shadow:0 0 14px rgba(39,220,231,.15)!important;margin:0!important;transform:translateX(-14px)!important;transition:transform 150ms ease,background 180ms ease!important;}
.st-key-apex_mobile_header button:active{transform:translateX(-14px) scale(.92)!important;}
